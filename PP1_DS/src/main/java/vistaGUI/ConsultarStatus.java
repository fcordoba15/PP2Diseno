...
public class ConsultarStatus extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ConsultarStatus
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CONSULTAR STATUS");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, -10, 320, 90));

        linea.setFont(new java.awt.Font("Snap ITC", 1, 36)); // NOI18N
        linea.setForeground(new java.awt.Color(0, 0, 102));
        linea.setText("________________________");
        getContentPane().add(linea, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 30, 460, 50));
        ...
        getContentPane().add(nombre2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, -1, -1));
