...
public class ConsultarGananciasTotales extends javax.swing.JFrame {
    ...
    private void btConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btConsultarActionPerformed
        ...
        if (tipoGanancia.equals("Depositos")){
            txtGanancias.setText(consultarGananciasDepositosBanco());
        }
        if (tipoGanancia.equals("Retiros")){
            txtGanancias.setText(consultarGananciasRetirosBanco());
        }
        if (tipoGanancia.equals("Depositos y retiros")){
            txtGanancias.setText(consultarGananciasTotalesBanco());
        }
