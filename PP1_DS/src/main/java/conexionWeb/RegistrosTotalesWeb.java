...
@WebServlet(urlPatterns = {"/RegistrosTotalesWeb"})
public class RegistrosTotalesWeb extends HttpServlet {
    ...
    if (Integer.parseInt(tipo) == 1){
        ...
        ArrayList<String> datosCSV = consultaCSV.consultarGeneralCSV(); 
        ...
        ArrayList<String> datosTRAMAPLANA = consultaTRAMAPLANA.consultarGeneralTramaPlana(); 
