...
@WebServlet(name = "ConsultarClienteWeb", urlPatterns = {"/ConsultarClienteWeb"})
public class ConsultarClienteWeb extends HttpServlet {
...
"        <nav>");
        ...
        for (int i = 0; i < listaDatos.size(); i++){
            ...
            out.println("<form METHOD=\"GET\" action=\"ClienteConsultadoWeb\">\n" +
"                <hr>\n" +
"                <label>Numero de cedula :</label>\n" +
"                <input type=\"Number\"  name=\"NUMEROCEDULA\" required>"
            + "            <br><br>\n" +
