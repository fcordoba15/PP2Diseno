...
@WebServlet(urlPatterns = {"/ConsultarGananciasTotalesWeb"})
public class ConsultarGananciasTotalesWeb extends HttpServlet {
    ...
    out.println("<html>");
    out.println("<head>");
    out.println("<title>Ganancias totales</title>");
